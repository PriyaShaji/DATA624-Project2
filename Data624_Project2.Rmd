...
\small
```{r sumstat}
kable(describe(train_df)[,-c(1,6,7)], 
...
<--- BUILD ANY ADDITIONAL MODEL HERE --->
THE MORE THE MERRIER, ADD PERFORMANCE METRIC BELOW
...
<--- ADD ANY OTHER FACTOR THAT CAN BE USE TO SELECT THE BEST MODEL --->
